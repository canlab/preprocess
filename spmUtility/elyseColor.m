...
% ====================================================================== 
!cp /data/ektrain/SPM_fMRIDesMtxCOLORSHAPE.mat ./SPM_fMRIDesMtx.mat
% this is irrelevant because we're specifying and estimating.

% define the vectors of onsets for each trial type
% ====================================================================== 

% For Color Shape
%	Baseline	HiIncong	Pure
c{1} = [0 340];
c{2} = 20:32:320;
c{3} = 36:32:350;
...
TOR.imgdir = ['/data/ektrain/task/' myDayCode '/colorshape'];
TOR.resdir = [pwd];
TOR.imgwildcard = 'ra*img';
...
% define globals for slice timing stuff.
% ====================================================================== 
global fMRI_T
global fMRI_T0
