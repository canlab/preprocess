...
maxMem   = 2^26;	%-Max data chunking size, in bytes
...
[nScan nVar]  = size(VY);
KVi           = spm_filter99('apply',xX.K, xX.xVi.Vi);
V             = spm_filter99('apply',xX.K,KVi');
xX.xKXs       = spm_sp('Set',spm_filter99('apply',xX.K, xX.X));
...
KVi      = spm_filter99('apply',xX.K, xX.xVi.Vi);
xX.V     = spm_filter99('apply',xX.K,KVi'); 	%-V matrix
