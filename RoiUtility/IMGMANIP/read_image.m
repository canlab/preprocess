...
%  Last modified 11/01/01 by Tor
% Last change: multiplies volume by SPM scaling factor.
...
if isempty(array)
	...
	fclose(pFile);
	   ...
	   % ===== multiply by SPM scalefactor =====
	if isfield(hdr,'SPM_scale')
		array = array .* hdr.SPM_scale;			% account for the SPM scaling factor!	
	end
