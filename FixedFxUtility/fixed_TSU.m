function clusters = fixed_TSU(clusters)
% function clusters = fixed_TSU(clusters)
%
% for fixed effects analysis clusters created in FixedFxUtility
% or for viewing clusters not made in SPM on the Talairach slices
% (made with tor_fixed_effects or mask2struct)
%
% modified by Tor Wager from original:
%
%function ihb_TalSpace
%----------------------------------------------------------------------------------
% FORMAT ihb_TalSpace
%----------------------------------------------------------------------------------
