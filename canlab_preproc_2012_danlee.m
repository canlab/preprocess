function canlab_preproc_2012_danlee(basedir, run_wildcard, image_wildcard, TR, struct_wildcard, varargin)
...
struct_dir_path = fullfile(basedir, 'Structural', struct_wildcard(1:length(struct_wildcard)-3), struct_wildcard);
