...
clear pstop
    ...
    varyslow = phatgo(1)./2:25:phatgo(1)+300;     %  cols, go slowdown param
    ...
    for ssr = 1:length(varystop)
        ...
        for r = 1:length(varyslow)  % muvals
            ...
            pgo(ssr,r) = Iexgauss(RTCUTOFF,[varyslow(r),phatgo(2),phatgo(3)]);
            ...
            pstop(ssr,r) = Calc_diff_exgauss2(varystop(ssr),phatgo(2),phatgo(3),varyslow(r),phatgo(2),phatgo(3),ssoffset);
