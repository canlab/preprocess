...
% MODIFIED BY TOR TO TAKE ACROSS-SESSION COVARIATES IN USER-SPEC.
% REGRESSORS.
%
% 1st level
%---------------------------------------------------------------------------
...
% TOR: added for covariates ACROSS sessions
if isfield(SPM,'usercovs');
    Xx = [Xx SPM.usercovs];
    Xname = [Xname SPM.usercovnames{:}];
end
