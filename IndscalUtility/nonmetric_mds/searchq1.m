...
%   $Revision: 1.13 $  $Date: 2001/03/27 19:55:14 $
%   Andy Grace 7-9-90.
if pcnt==1
...
elseif pcnt==2  & fnew< matl(2)
    newstep=cubici21(gdold,[matl(1);matl(2);fnew],[matx(1);matx(2);stepsize]);
...
elseif pcnt==3 & fnew>=matl(1)
    ...
    if stepsize<1e-6
        ...
        newstep=cubici21(gdold,[matl(1);matl(3);fnew],[matx(1);matx(3);stepsize]);
    end
    matx(3)=stepsize;
...
elseif pcnt==2 & fnew>=matl(2)
    matx(3)=stepsize;
    matl(3)=fnew;
    [stepsize]=cubici21(gdold,matl,matx);
    pcnt=4;
